...
const projectData = [
	...
	},
	{
		id: 31,
		category: "Mobile",
		name: "Mobile Structure & App Shell",
		start: "2026-01-19",
		end: "2026-01-31",
		owner: "Mobile Dev",
		deliverables: ["Navigation", "Auth Screens", "Layout Setup"],
		desc: "Setting up the React Native shell and core navigation flows.",
		color: "#f97316",
		type: "Dev",
	},
	{
		id: 32,
		category: "Mobile",
		name: "Booking & Service Flows",
		start: "2026-02-01",
		end: "2026-02-15",
		owner: "Mobile Dev",
		deliverables: ["Booking Form", "Service Selection", "History View"],
		desc: "Implementing the core booking logic and user service interaction.",
		color: "#fdba74",
		type: "Dev",
	},
	{
		...
		owner: "Mobile Dev",
		deliverables: ["User Profile", "Settings", "Static Pages"],
		desc: "User account management and application settings screens.",
		color: "#fed7aa",
		type: "Dev",
	},
	{
		id: 41,
		category: "Backend",
		name: "Core Setup & Auth",
		start: "2026-02-03",
		end: "2026-02-14",
		owner: "Backend Dev",
		deliverables: ["DB Schema", "JWT Auth", "Base API Structure"],
		desc: "Initial database modeling and secure authentication layer.",
		color: "#2563eb",
		type: "Dev",
	},
	{
		...
		owner: "Backend Dev",
		deliverables: ["User CRUD", "RBAC (Roles)", "Admin APIs"],
		desc: "Comprehensive user administration and access control.",
		color: "#3b82f6",
		type: "Dev",
	},
	{
		id: 43,
		category: "Backend",
		name: "Asset Management (Tank/Vehicle)",
		start: "2026-02-25",
		end: "2026-03-10",
		owner: "Backend Dev",
		deliverables: ["Vehicle Registry", "Tank CRUD", "Assignment Logic"],
		desc: "Core business logic for managing fleet and fuel assets.",
		color: "#60a5fa",
		type: "Dev",
	},
	{
		...
		owner: "Backend Dev",
		deliverables: ["TCP/UDP Listener", "Data Parsing", "TimescaleDB"],
		desc: "High-throughput service for processing raw sensor data.",
		color: "#2563eb",
		type: "Dev",
	},
	{
		...
		owner: "Backend Dev",
		deliverables: ["TukuPay Integ.", "SMS/Email Alerts", "Invoicing"],
		desc: "Financial transaction processing and automated alerts.",
		color: "#1d4ed8",
		type: "Dev",
	},
	{
		id: 51,
		category: "Web",
		name: "Web Layout & User Management",
		start: "2026-02-10",
		end: "2026-02-25",
		owner: "Frontend Dev",
		deliverables: ["Admin Shell", "User CRUD", "Role Management"],
		desc: "Core admin dashboard layout and user administration modules.",
		color: "#7c3aed",
		type: "Dev",
	},
	{
		id: 52,
		category: "Web",
		name: "Live Map & Tracking Dashboard",
		start: "2026-02-26",
		end: "2026-03-10",
		owner: "Frontend Dev",
		deliverables: ["Google Maps Integration", "Asset Overlay"],
		desc: "Real-time map visualization and asset tracking interface.",
		color: "#8b5cf6",
		type: "Dev",
	},
	{
		id: 53,
		category: "Web",
		name: "Analytics & Reporting UI",
		start: "2026-03-11",
		end: "2026-03-21",
		owner: "Frontend Dev",
		deliverables: ["Charts", "Data Grid", "Export Tools"],
		desc: "Data visualization, reporting tools, and export functionality.",
		color: "#a78bfa",
		type: "Dev",
	},
	{
	...
	},
	{
		id: 71,
		category: "Mobile",
		name: "Data Binding & State Integration",
		start: "2026-03-02",
		end: "2026-03-15",
		owner: "Mobile Dev",
		deliverables: ["API Logic", "State Mgmt", "Data Fetching"],
		desc: "Connecting mobile UI components to backend API services.",
		color: "#ea580c",
		type: "Dev",
	},
	{
		id: 72,
		category: "Mobile",
		name: "Push Notifications & Map Sync Integration",
		start: "2026-03-16",
		end: "2026-03-26",
		owner: "Mobile Dev",
		deliverables: ["Firebase Setup", "Real-time Updates", "Map Sync"],
		desc: "Implementing real-time features and notification services.",
		color: "#f97316",
		type: "Dev",
	},
	{
	...
	const getFilteredTasks = (type) => {
		...
		return projectData.filter(
			(t) =>
				...
				(type === "FE(Web)" &&
					(t.category === "Web" || t.name.includes("Integration"))) ||
